...
(define (cairo_create target)
  ...
  (let ((~target (unwrap-cairo_surface_t* target)))
    (wrap-cairo_t* (~cairo_create ~target))))
(export cairo_create)
...
(define (cairo_reference cr)
  ...
  (let ((~cr (unwrap-cairo_t* cr)))
    (wrap-cairo_t* (~cairo_reference ~cr))))
...
(define (cairo_pop_group cr)
  ...
  (let ((~cr (unwrap-cairo_t* cr)))
    (wrap-cairo_pattern_t* (~cairo_pop_group ~cr))))
...
(define (cairo_get_source cr)
  ...
  (let ((~cr (unwrap-cairo_t* cr)))
    (wrap-cairo_pattern_t* (~cairo_get_source ~cr))))
...
(define (cairo_get_target cr)
  ...
  (let ((~cr (unwrap-cairo_t* cr)))
    (wrap-cairo_surface_t* (~cairo_get_target ~cr))))
...
(define (cairo_copy_path cr)
  ...
  (let ((~cr (unwrap-cairo_t* cr)))
    (wrap-cairo_path_t* (~cairo_copy_path ~cr))))
  ...
  (unless
    ...
    (set! ~cairo_copy_path_flat
      (fh-link-proc
        ...
        (list '*))))
  (let ((~cr (unwrap-cairo_t* cr)))
    (wrap-cairo_path_t* (~cairo_copy_path_flat ~cr))))
...
(define (cairo_region_create)
  ...
  (let ()
    (wrap-cairo_region_t* (~cairo_region_create))))
