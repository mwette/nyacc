...
;; Copyright (C) 2015,2018,2021,2024 Matthew Wette
;;
...
(define-module (language nx-javascript parser)
...
(include-from-path "language/nx-javascript/mach.d/js-tab.scm")
(include-from-path "language/nx-javascript/mach.d/js-act.scm")
