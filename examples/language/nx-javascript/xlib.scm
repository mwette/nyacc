;;; language/nx-javascript/xlib.scm - extension library

;; Copyright (C) 2015,2017-2018,2024 Matthew Wette
;;
...
(define-module (language nx-javascript xlib)
  #:export (JSdict
            js:undefined
            js:null
            )
...
(include-from-path "language/nx-javascript/xlib-01.scm")
