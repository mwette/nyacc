...
(define-module (language nx-javascript compile-tree-il)
  #:export (compile-tree-il show-javascript-sxml show-javascript-xtil)
  #:use-module (language nx-javascript xlib)
...
(define xlib-mod '(language nx-javascript xlib))
(define (xlib-ref name) `(@@ (language nx-javascript xlib) ,name))
...
(define xlib-module (resolve-module '(language nx-javascript xlib)))
