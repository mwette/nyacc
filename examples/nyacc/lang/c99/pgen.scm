   ...
   (grammar
    ...
    (enumeration-type-definition
     ("enum" enumeration-tag "{" enumeration-definition-list "}"
      ($$/ref 's5.5-01 `(enum-def ,$2 ,(tl->list $4))))
     ("enum" enumeration-tag "{" enumeration-definition-list "," "}"
      ($$/ref 's5.5-02 `(enum-def ,$2 ,(tl->list $4))))
     ("enum" "{" enumeration-definition-list "}"
      ($$/ref 's5.5-03 `(enum-def ,(tl->list $3))))
     ("enum" "{" enumeration-definition-list "," "}"
    ...
    (component-declaration
     (specifier-qualifier-list ;; <= changed, was type-specifier from HB
    ...
    (specifier-qualifier-list
     (type-specifier specifier-qualifier-list
		     ($$/ref 's-tbd-1 (tl-insert $2 $1)))
     (type-specifier ($$/ref 's-tbd-1 (make-tl 'decl-spec-list $1)))
     (type-qualifier specifier-qualifier-list
		     ($$/ref 's-tbd-1 (tl-insert $2 $1)))
     (type-qualifier ($$/ref 's-tbd-1 (make-tl 'decl-spec-list $1)))
     )
    ...
    (component-declarator
     (simple-component ($$ `(comp-declr ,$1)))
     (bit-field ($$ `(comp-declr ,$1)))
     )
    ...
    (direct-component-selection
     (postfix-expression "." identifier ($$/ref 's7.4.2-01 `(d-sel ,$1 ,$3)))
     )
    
    (indirect-component-selection
     (postfix-expression "->" identifier ($$/ref 's7.4.2-02 `(i-sel ,$1 ,$3)))
     )
