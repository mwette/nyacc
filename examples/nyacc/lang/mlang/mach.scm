...
(define (gen-mlang-files . rest)
  ...
  (write-lalr-tables mlang-mach (xtra-dir "mlang-tab.scm.new")
		     #:prefix "mlang-")
  (write-lalr-actions mlang-ia-mach (xtra-dir "mlang-ia-act.scm.new")
		      #:prefix "mlang-ia-")
  (write-lalr-tables mlang-ia-mach (xtra-dir "mlang-ia-tab.scm.new")
		     #:prefix "mlang-ia-")
  (let ((a (move-if-changed (xtra-dir "mlang-act.scm.new")
	...
	(c (move-if-changed (xtra-dir "mlang-ia-act.scm.new")
			    (xtra-dir "mlang-ia-act.scm")))
	(d (move-if-changed (xtra-dir "mlang-ia-tab.scm.new")
			    (xtra-dir "mlang-ia-tab.scm"))))
    (or a b c d)))
